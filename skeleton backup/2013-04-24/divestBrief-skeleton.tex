...
% last modified by Milan Ilnyckyj - 2013-04-15
...
\bibliography{briefbib-0-7-milan.bib}
...
\begin{vcom}
	Outstanding general issues: (a) standardize dates, spelling, formatting of the names of court cases, etc (b) fix the references that mysteriously render only as periods in the bibliography (c) deal with other \LaTeX errors (d) deal with these citekeys that aren't working TorontoEnvOff2008 TorontoAQandCC UTAM_2012
\end{vcom}
