...
% \centering
% \caption{\ce{CO2} concentrations in an ice core from Vostok, Antarctica}
% \label{fig:Vostok}
% \end{figure}
...
These findings are echoed in recent research, including a 2013 article that emphasized how: ``[a] shift to a 2˚C pathway requires immediate significant and sustained global mitigation''.\footcite[][p. 1]{ChallengeTwoDegrees} \footcite[See also: ][]{EmissionTargetsTwoDegrees}
