...
In addition, financial analysis of the risk of removing fossil fuel stocks from a portfolio has found that the added risk ``can be so minor as to be virtually irrelevant''.\footcite{Aperio2013}
...
The Obama administration is expected to move forward with emissions limits on existing power plants.\footcite[][]{ReadyingLimits}
